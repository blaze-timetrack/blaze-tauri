import { AnimatedBackground } from "@/components/extented ui/animated-background.tsx";

export function SegmentedControl() {
  return (
    <div className="flex flex-col gap-4 rounded-[8px] bg-gray-100 p-[2px] dark:bg-zinc-800">
      <AnimatedBackground
        defaultValue="Day"
